...
本目录存放 EatWhat 项目参加比赛过程中产生的各类材料。
...
1. 本目录文件以**归档和参考**为主，赛后打磨阶段不再频繁修改。
2. 如果比赛进入下一轮或参加其他比赛，可在此基础上复用，但不要覆盖原始提交版本。
3. 技术报告书中的"当前架构/当前功能"描述若与代码不一致，以 `docs/design/eatwhat.md` 和实际代码为准。
