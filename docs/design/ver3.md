# 问膳 (EatWhat) — 设计文档 v4(数据源迁移版)

> **本文档是 EatWhat 项目 v4 的权威设计文档**（文件名为 `ver3.md`，内容已升级到 v4，记录从 B 站数据源迁移到小红书数据源的完整设计变更）。**ver2.md 即时冻结作 v3 历史归档，ver3.md 为当前权威**。任何后续代码、文档、AI 协作都以本文档为准；ver1.md、update1.txt、ver2.md 仅作历史归档（位于 `docs/design/`）。
